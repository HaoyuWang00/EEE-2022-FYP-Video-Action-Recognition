...
dataset_path = '/home/students/s121md105_01/temporal-shift-module/data/kinetics/400/output/test_videos_part_0'
label_path = '/home/students/s121md105_01/temporal-shift-module/data/kinetics/400/labels'
...
if __name__ == '__main__':
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            # dataset_path/sled_dog_racing/zzokQ8DKETs_112/xxx.img
