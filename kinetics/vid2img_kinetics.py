...
def vid2jpg(file_name, class_path, dst_class_path):
    ...
    try:
        ...
        return
    cmd = 'ffmpeg -i \"{}\" -threads 1 \"{}/img_%05d.jpg\"'.format(video_file_path, dst_directory_path)
...
if __name__ == "__main__":
    # each time, only one split will be processed
    # dir_path is to the split folder
    dir_path = sys.argv[1]
